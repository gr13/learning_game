MODULE_REGISTRY = {
    "CORE": "app.modules.vocabulary.core.engine",
    "DOMAIN": "app.modules.vocabulary.domain.engine",
    "READING": "app.modules.exam.reading.engine",
    "WRITING": "app.modules.exam.writing.engine",
    "SPEAKING": "app.modules.exam.speaking.engine",
}
...
# from api.app.utils.ai.chatgpt import ChatGPT
# from api.app.utils.sessions.session_store import SessionStore
# from api.app.utils.plans.plans import MODULE_1_PLAN
# from api.app.utils.api_helpers.response_handler import ResponseHandler
# from api.app.utils.api_helpers.schemas import EXPLANATION_SCHEMA
